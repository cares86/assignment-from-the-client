...
<body>
  <div id="social">
         <button onClick="window.open('http://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.developphp.com%2Fvideo%2FFlash%2FWebsite-Guestbook-Tutorial','sharer','toolbar=0,status=0,width=580,height=400');" title="Share on Facebook"></button><button onClick="window.open('http://plus.google.com/share?url=https%3A%2F%2Fwww.developphp.com%2Fvideo%2FFlash%2FWebsite-Guestbook-Tutorial','share','toolbar=0,status=0,width=550,height=450');" title="Share on Google Plus"></button><button onClick="window.open('http://www.twitter.com/intent/tweet?url=https%3A%2F%2Fwww.developphp.com%2Fvideo%2FFlash%2FWebsite-Guestbook-Tutorial&amp;text=Flash - Website Guestbook Tutorial','tweety','toolbar=0,status=0,width=550,height=450');" title="Tweet this"></button><button onClick="window.location='mailto:?subject=Flash - Website Guestbook Tutorial&body=Hi, I thought you might like to see this: %0D%0Ahttps://www.developphp.com/video/Flash/Website-Guestbook-Tutorial';" title="Send this to an email contact"></button>

       </div>
       <nav>
     		<ul>
     		  <li><a href="#home" title="Home" id="default" class="highlite" onclick="highlite(this);"> <i home  class="navbarlogo fa fa-home" aria-hidden="true">  </i> </a></li>
     			<li><a href="#barista" title="Barista" onclick="highlite(this);"> <i class="navbarlogo fa fa-coffee" aria-hidden="true"></i> </a></li>
     			<li><a href="#koks" title="Koks" onclick="highlite(this);"> <i class="navbarlogo fa fa-user" aria-hidden="true"></i> </a></li>
...
<!------------------------------------Section4------------------------------------->
<div id="section4b" class="section4b">
</div>
<!------------------------------------Section5------------------------------------>
...
<script src="jquery.smoothPageScroll.js" type="text/javascript"></script>
